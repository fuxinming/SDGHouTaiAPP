...
@interface ChangeSaleViewController (){
...
-(void)onHandleNextClicked{
    ...
    if(arr.count > 0){
        ...
        NSMutableDictionary *dict = [[NSMutableDictionary alloc]init];
        [dict setObject:jsonString forKey:@"sServer"];
        
        [self showLoading];
        [NSObject postDataWithHost:Server_Host Path:ProductSServer Param:dict isCache:NO success:^(id json) {
